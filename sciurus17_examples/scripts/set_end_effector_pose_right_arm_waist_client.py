...
class SetEndEffectorPoseRightArmWaist(Node):
    def __init__(self):
        super().__init__('set_pose_client')
        self._client = ActionClient(self, SetPose, 'set_end_effector_pose_right_arm_waist')
...
def main():
    rclpy.init()
    client = SetEndEffectorPoseRightArmWaist()
