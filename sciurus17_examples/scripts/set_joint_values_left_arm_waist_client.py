...
class SetJointValuesLeftArmWaist(Node):
    def __init__(self):
        super().__init__('set_joint_values_client')
        self._client = ActionClient(self, SetJointValues, 'set_joint_values_left_arm_waist')
...
def main():
    rclpy.init()
    client = SetJointValuesLeftArmWaist()

    # 任意の関節角度（ラジアン）
    joint_values = [0.0536893, 0.374291, 1.58767, -0.0644272, -2.73202, -0.0276117, 1.75334, 0.107379]
